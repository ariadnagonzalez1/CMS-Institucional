...
@section('header-title', 'Agregar Administrador')
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="password" 
                               name="password" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#1a3b2e] focus:border-transparent @error('password') border-red-500 @enderror"
                               placeholder="Clave max. 8 caracteres">
                        @error('password')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-gray-400 text-xs mt-1">Máximo 8 caracteres</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="sala_redaccion_id" 
                            ...
                            @foreach($salasRedaccion as $sala)
                                <option value="{{ $sala->id }}" {{ old('sala_redaccion_id') == $sala->id ? 'selected' : '' }}>
                                    {{ $sala->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="modo_grupo_id" 
                            ...
                            @foreach($modosGrupo as $modo)
                                <option value="{{ $modo->id }}" {{ old('modo_grupo_id') == $modo->id ? 'selected' : '' }}>
