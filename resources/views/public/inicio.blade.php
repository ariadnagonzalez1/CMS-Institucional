...
<section class="relative h-[88vh] min-h-[520px] overflow-hidden bg-gray-900">
    ...
    @empty
    {{-- Fallback cuando no hay banners cargados --}}
    <div class="hero-slide active">
        <div class="absolute inset-0" style="background:linear-gradient(135deg,#1a3b2e 0%,#2a5a45 100%)"></div>
        <div class="absolute inset-0 flex items-center">
            <div class="max-w-7xl mx-auto px-6">
                <h1 class="font-display text-white text-5xl md:text-7xl font-bold leading-tight max-w-2xl mb-4">
                    Formando el Futuro<br>de la Ingeniería
                </h1>
                <p class="text-white/75 text-lg max-w-xl">
                    Compromiso con la excelencia profesional y el desarrollo de Formosa
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="relative h-52 bg-gray-200 overflow-hidden">
                    ...
                    <div class="play-btn absolute inset-0 flex items-center justify-center">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center"
                             style="background:rgba(42,90,69,.9)">
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mt-10 fade-up">
            ...
            <a href="{{ $config->instagram_url }}" target="_blank" rel="noopener"
               class="red-social-btn flex items-center justify-center py-5 rounded-sm text-white"
